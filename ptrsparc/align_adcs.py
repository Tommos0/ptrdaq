...
## Brent
#####################################
    def set_align_brent(self):
        #self._set_individual_offsets([128,124,136,127])#cold
        #self._set_individual_gains([162,134,100,123])#cold
        #self._set_full_scale(44)#cold
        #self._set_common_offset(126)#cold
        self._set_individual_offsets([127,123,135,126])#warm
        self._set_individual_gains([159,132,99,120])#warm
        self._set_full_scale(43)#warm
        self._set_common_offset(130)#warm
